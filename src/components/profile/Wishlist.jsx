...
const Wishlist = () => {
 ...
 const[deleteProduct,{data:res,isSuccess:succ}]=useDeleteProductFromWishListMutation(); 
  ...
  return (
    <div className='w-full larger:w-full flex small:w-fit px-3 mx-auto larger:justify-center  '>
      ...
      <div className='w-fit larger:w-full  flex-grow flex flex-col larger:flex larger:flex-row-reverse larger:items-start xlarge:self-end'> 
      <Profilecard/>
